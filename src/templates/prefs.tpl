...
<div class="c_full cf">
  ...
  <div class="grid_8">
    {xt_yesno_options prefix=$actionid name='skurequired' selected=$skurequired}
  </div>
</div>
<div class="c_full cf">
...
<div class="c_full cf">
  ...
  <div class="grid_8">
    {xt_yesno_options prefix=$actionid name='summary_newdefault' selected=$summary_newdefault}
  </div>
</div>
<div class="c_full cf">
...
<div class="c_full cf">
  ...
  <div class="grid_8">
    {xt_yesno_options prefix=$actionid name='prettyhierurls' selected=$prettyhierurls}
