...
<div class="c_full cf">
  ...
  <div class="grid_9">
    {xt_yesno_options prefix=$actionid name=exportdraft selected=$options.exportdraft}
  </div>
</div>
...
<div class="c_full cf">
  ...
  <div class="grid_9">
    {xt_yesno_options prefix=$actionid name=exportcats selected=$options.exportcats}
  </div>
</div>
...
<div class="c_full cf">
  ...
  <div class="grid_9">
    {xt_yesno_options prefix=$actionid name=exportfields selected=$options.exportfields}
  </div>
</div>
...
<div class="c_full cf">
  ...
  <div class="grid_9">
    {xt_yesno_options prefix=$actionid name=exportoptions selected=$options.exportoptions}
  </div>
</div>
</div>{* #formwrapper *}
