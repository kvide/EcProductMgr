...
if (isset($params['submit']))
{
    ...
    {
        $query = 'SELECT id FROM ' . cms_db_prefix() . 'module_ec_prodmgr_categories
                    WHERE name = ?';
        ...
        else
        {
            ...
            $query = 'INSERT INTO ' . cms_db_prefix() . "module_ec_prodmgr_categories
...
# Display Template
$smarty->assign('startform', $this->CreateFormStart($id, 'copycategory', $returnid));
