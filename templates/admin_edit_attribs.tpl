...
<a id="add_option">{xtimage image='icons/system/newobject.gif' alt=$mod->Lang('addoption') class='systemicon'} {$mod->Lang('addoption')}</a>
</div>
{$formstart}
<table class="pagetable" cellspacing="0" id="attrib_table">
  ...
  <tbody>
    <tr id="skel_row" style="display: none;">
      ...
      <td><input type="hidden" class="notes" name="{$actionid}notes[]" value="{$skel_row->notes}"/>{xtimage image='icons/system/edit.gif' class="edit_notes" alt=$mod->Lang('edit_notes')}</td>
      <td>{xtimage image='icons/system/copy.gif' class="copy_option" alt=$mod->Lang('copy_attribute')}
      <td>{xtimage image='icons/system/delete.gif' class="del_option" alt=$mod->Lang('delete_attribute')}
    </tr>
  ...
  {foreach $attribs as $attrib}
    <tr id="attrib_{$attrib->id}">
      ...
      <td><input type="hidden" class="notes" name="{$actionid}notes[]" value="{$attrib->notes}"/>{xtimage image='icons/system/edit.gif' class="edit_notes" alt=$mod->Lang('edit_notes')}</td>
      <td>{xtimage image='icons/system/copy.gif' class="copy_option" alt=$mod->Lang('copy_attribute')}
      <td>{xtimage image='icons/system/delete.gif' class="del_option" alt=$mod->Lang('delete_attribute')}
    </tr>
  {/foreach}
